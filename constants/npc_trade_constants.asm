...
NPCTRADE_NICK    EQU  3 ; ds 4
NPCTRADE_DVS     EQU  7 ; dw
NPCTRADE_ITEM    EQU  9 ; db
NPCTRADE_OT_ID   EQU 10 ; dw
NPCTRADE_OT_NAME EQU 12 ; ds 3
NPCTRADE_GENDER  EQU 15 ; db
NPCTRADE_PADDING EQU 16 ; db
