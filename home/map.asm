...
ScriptNotValid::
	ld a, BANK(StrangeEvent)
	ld [wScriptBank], a
	ld a, LOW(StrangeEvent)
	ld [wScriptPos], a
	ld a, HIGH(StrangeEvent)
	ld [wScriptPos + 1], a
	ld a, PLAYEREVENT_MAPSCRIPT
	ld [wScriptRunning], a
	scf
...
CheckScriptValidity::
; If the script is in ROM, it's valid
